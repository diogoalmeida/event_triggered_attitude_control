...
q_b(1,:) = angle_to_quat([deg2rad(-45) 0 0]);
...
plot(1/F:1/F:T,torques(1:end-1,1),'r','Linewidth',line);
...
plot(1/F:1/F:T,abs(-45-rad2deg(2*acos(q_b(:,4)))),'Linewidth',line);
