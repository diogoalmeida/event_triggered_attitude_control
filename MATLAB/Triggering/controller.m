function [ torques phi theta D q_xy q_z art_torques q phi_dot theta_dot switch_phi switch_theta v_dot] = controller(q_d,q_b,w,var)
...
%the controller.
   ...
   [D phi_dot theta_dot switch_phi switch_theta] = comp_damp_matrix(qx,qy,qz,qp,qw,w,T_z,T_phi,art_torques,var);
